const features = [
  {
    ...
    title: 'Record Audio',
    description: 'Capture speech directly from your browser microphone with a single click. No plugins needed.',
  ...
  },
  {
    ...
    title: 'Upload Files',
    description: 'Drag and drop or upload audio files in any format — MP3, WAV, M4A, FLAC, and more.',
  ...
  },
  {
    ...
    title: 'Save & Organize',
    description: 'All transcriptions are stored in MongoDB. Search, filter, and manage your text history.',
  ...
  },
  {
    ...
    description: 'Real-time streaming transcription. See words appear as you speak — no waiting around.',
  ...
  },
  {
    ...
    description: 'Beautiful on every device. Record from your phone, transcribe on your tablet, review on desktop.',
